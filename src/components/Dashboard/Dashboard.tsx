...
import { Brain, Calculator, Crown, Shield, TrendingUp, Users, Clock, Calendar, AlertTriangle, Lock } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tools.map((tool, index) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-all duration-200 relative"
                >
                  {tool.premium && (
                ...
                >
                  <div className="absolute inset-0 bg-gray-900/80 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-white font-medium">Prémium Eszköz</p>
                      <p className="text-gray-400 text-xs mt-1">VIP előfizetés szükséges</p>
                    </div>
                  </div>
                  <div className="flex items-center mb-4">
