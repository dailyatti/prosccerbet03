...
import { Calculator, TrendingUp, RefreshCw, DollarSign, Percent, Clock, Search, Filter, Lock, Crown, ArrowRight } from 'lucide-react';
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-gray-400 mb-4">
              Az Arbitrage Kalkulátor csak VIP előfizetők számára érhető el.
            </p>
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-lg p-4 mb-6">
              ...
              <ul className="text-gray-300 text-sm space-y-1">
                <li>• Valós idejű odds adatok</li>
                <li>• Automatikus profit számítás</li>
                <li>• Professzionális elemzés</li>
                <li>• Exkluzív arbitrage lehetőségek</li>
              </ul>
            </div>
          </div>
