...
import { Brain, Upload, Type, Wand2, Copy, Download, AlertCircle, CheckCircle, Image, FileText, Lock, Crown, ArrowRight } from 'lucide-react';
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-gray-400 mb-4">
              Az AI Prompt Generátor csak VIP előfizetők számára érhető el.
            </p>
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg p-4 mb-6">
              <h3 className="text-white font-semibold mb-2 flex items-center justify-center">
                ...
                VIP Előfizetés Szükséges
              </h3>
              <ul className="text-gray-300 text-sm space-y-1">
                <li>• Professzionális AI promptok</li>
                <li>• Kép alapú prompt generálás</li>
                <li>• Exkluzív prompt könyvtár</li>
          ...
          <div className="space-y-4">
            {!user ? (
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium py-3 px-6 rounded-lg transition-colors inline-block w-full flex items-center justify-center space-x-2"
              >
